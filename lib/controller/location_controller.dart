...
class LocationController extends GetxController implements GetxService {
  ...
  Position _position = Position(longitude: 0, latitude: 0, timestamp: DateTime.now(), accuracy: 1, altitude: 1, heading: 1, speed: 1, speedAccuracy: 1,headingAccuracy:1, altitudeAccuracy: 1);
  Position _pickPosition = Position(longitude: 0, latitude: 0, timestamp: DateTime.now(), accuracy: 1, altitude: 1, heading: 1, speed: 1, speedAccuracy: 1,headingAccuracy:1, altitudeAccuracy: 1);
  bool _loading = false;
  String? _address = '';
  String? _pickAddress = '';
    ...
    try {
      ...
      myPosition = Position(
        ...
        timestamp: DateTime.now(), accuracy: 1, altitude: 1, heading: 1, speed: 1, speedAccuracy: 1,
          headingAccuracy:1, altitudeAccuracy: 1
      );
    }
    if(fromAddress) {
  ...
  Future<ResponseModel> addAddress(AddressModel addressModel, bool fromAuth, bool fromCheckout, bool fromRide, int? storeZoneId) async {
    _isLoading = true;
    update();
  ...
  void saveZoneData({required AddressModel addressModel}){
    _setZoneData(addressModel,false, '', false, ResponsiveHelper.isDesktop(Get.context));
  }
