                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <label class="toggle-switch toggle-switch-sm" for="toggleColumn_total_order">
                                            <input type="checkbox" class="toggle-switch-input" id="toggleColumn_total_order"
                                                checked>
                                            <span class="toggle-switch-label">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">{{ translate('messages.active') }}/{{ translate('messages.cod') }}
                                </th>
                                <th class="border-0">
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm ml-xl-4"
                                            ...
                                            <input type="checkbox"
                                                onclick="status_change_alert('{{ route('admin.users.customer.status-cod', [$customer->id, $customer->cod ? 0 : 1]) }}', '{{ $customer->cod ? translate('messages.you_want_to_disable_cod') : translate('messages.you_want_to_enable_cod') }}', event)"
                                                class="toggle-switch-input" id="stocksCheckbox{{ $customer->id }}"
                                                {{ $customer->cod ? 'checked' : '' }}>
                                            <span class="toggle-switch-label">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
