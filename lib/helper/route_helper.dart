...
class RouteHelper {
  ...
  // static String getVerificationRoute(String? number, String? token, String page,
  //     String pass
  //     ) {
  //   return '$verification?page=$page&number=$number&token=$token&pass=$pass';
  // }

  static String getVerificationRoute(String? number, String page,
      ) {
  ...
  static String getAddAddressRoute(bool fromCheckout, bool fromRide, int? zoneId,bool fromAuth) => '$addAddress?page=${fromCheckout ? 'checkout' : fromAuth ? 'fromAuth' : 'address'}&ride=$fromRide&zone_id=$zoneId';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: addAddress, page: () => getRoute(AddAddressScreen(
      fromAuth: Get.parameters['page'] == 'fromAuth',
    ...
    GetPage(name: editAddress, page: () => getRoute(AddAddressScreen(
      fromCheckout: false, fromRide: false,fromAuth: false,
