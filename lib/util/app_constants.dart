...
class AppConstants {
  ...
  // static const String baseUrl = 'https://192.168.1.9';
  static const String baseUrl = 'https://ladybugg.v4inspire.com';
  ...
  static const String loginUri = '/api/v1/auth/authenticate';
  ...
  static const String codChargeUri = '/api/v1/get-cod-charges';
  ...
  //LEADERBOARD
  static const String getLeaderboardUri = '/api/v1/leaderships';

  static const String enableCODUri = '/api/v1/check-user-cod';

  // Shared Key
  static const String theme = '6ammart_theme';
  static const String token = '6ammart_token';
  static const String id = '6ammart_id';
