...
class MyInAppBrowser extends InAppBrowser {
  ...
  final bool isCashOnDelivery;
  final String? addFundUrl;
  MyInAppBrowser({required this.orderID, required this.orderType, required this.orderAmount, required this.maxCodOrderAmount, required this.isCashOnDelivery, this.addFundUrl, super.windowId, super.initialUserScripts});
