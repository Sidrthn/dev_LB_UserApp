...
class WebPopularItemView extends StatelessWidget {
  ...
  const WebPopularItemView({super.key, required this.itemController, required this.isPopular, this.showInSlider = false});
...
class WebCampaignShimmer extends StatelessWidget {
  final bool enabled;
  final bool isPopular;
  const WebCampaignShimmer({super.key, required this.enabled, required this.isPopular});
