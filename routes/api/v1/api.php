...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::post('authenticate', 'CustomerAuthController@authenticate');
    ...
    Route::post('leaderships', 'LeaderboardController@getLeaderboard');
    Route::post('check-user-cod', 'LeaderboardController@check_cod');
    ...
    Route::group(['prefix' => 'config'], function () {
        ...
        Route::get('/{user_id?}', 'ConfigController@configuration');
    });
    ...
    Route::get('get-cod-charges', 'ConfigController@cod_charges');
