                            ...
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-right">
                                    @if (!$parcel_order)
                                        ...
                                        <dt class="col-6">{{ translate('messages.COD_amount') }}:</dt>
                                        <dd class="col-6">
                                            {{ \App\CentralLogics\Helpers::format_currency($order->cod_amount) }}</dd>
                                    ...
                                    <dd class="col-6">
                                        ...
                                        {{ \App\CentralLogics\Helpers::format_currency($product_price + $del_c + $order->cod_amount + $total_tax_amount + $total_addon_price + $deliverman_tips + $additional_charge - $coupon_discount_amount - $store_discount_amount) }}
            ...
            <div class="col-lg-4 order-print-area-right">
                ...
                <form id="updateOrderForm">
                    ...
                    <div class="card" style="margin-top:20px;">
                        <div class="card-header justify-content-center">
                            <h5 class="card-title">{{ translate('Delivery Fee') }}</h5>
                        </div>
                        <div class="card-body">

                            <label style="margin-top:10px;">Delivery Fee</label>
                            <input type="number" class="form-control" name="delivery_fee" value="{{ $order['delivery_charge'] }}"
                                placeholder="{{ translate('Delivery_fee') }}">
            ...
            $('#updateOrderForm').on('submit', function(event) {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        alert('Failed to update order details'); // Display error message
                    }
                });
            });
        });
