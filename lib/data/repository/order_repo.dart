...
class OrderRepo {
  ...
  Future<Response> getCODCharge() async {
    return await apiClient.getData(AppConstants.codChargeUri);
  }
  ...
  Future<Response> checkEnableCOD(String userId) async {
    return await apiClient.postData(AppConstants.enableCODUri, { 'user_id': userId});
  }
}