            ...
            Container(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                Image.asset(Get
                    ...
                    .darkTheme ? Images.congratulationDark : Images
                    .congratulationLight, width: 100, height: 100),

                Text('congratulations'.tr, style: robotoMedium.copyWith(
                ...
                Padding(
                  ...
                  child: Text(
                    '${'you_will_earn'.tr} ${Get.find<AuthController>()
                        .getEarningPint()} ${'points_after_completing_this_order'
                        .tr}',
