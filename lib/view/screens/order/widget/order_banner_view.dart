...
class OrderBannerView extends StatelessWidget {
  ...
  const OrderBannerView({super.key, required this.order, required this.ongoing, required this.parcel, required this.prescriptionOrder, required this.orderController, });
