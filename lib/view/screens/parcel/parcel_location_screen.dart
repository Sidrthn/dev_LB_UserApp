  ...
  void initState() {
    ...
    if (Get.find<AuthController>().isLoggedIn()){
      if(Get.find<UserController>().userInfoModel == null){
        ...
        _senderNameController.text = Get.find<UserController>().userInfoModel != null ? '${Get.find<UserController>().userInfoModel!.fName!} '
        ...
        _senderNameController.text = '${Get.find<UserController>().userInfoModel!.fName!} ';
            // '${Get.find<UserController>().userInfoModel!.lName!
