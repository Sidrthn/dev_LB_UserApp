                        ...
                        <div class="col-md-12">
                            <div class="__card-vertical">
                                ...
                                <h4 class="earning text-0661CB">
                                    {{ \App\CentralLogics\Helpers::number_format_short($admin_earned + $admin_earned_delivery_commission) }}
                                </h4>
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <tbody id="set-rows">
                            @foreach ($order_transactions as $k => $ot)
                                <tr scope="row">
                                    ...
                                    @if ($ot->order && $ot->order->order_type == 'parcel')
                                        <td><a
                                    ...
                                    @php
                                        ...
                                        if (
                                            isset($ot) &&
                                            isset($ot->order) &&
                                            isset($ot->order->details) &&
                                            isset($ot->order->details[0]) &&
                                            isset($ot->order->details[0]['item_details'])
                                        ) {
                                            $itemDetails = json_decode($ot->order->details[0]['item_details'], true);
                                        }
                                    @endphp
                                    ...
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency(optional(optional($ot->order)->details)->sum('discount_on_item')) }}
                                    </td>
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order && $ot->order['coupon_discount_amount']) }}
                                    </td>
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::number_format_short($ot->order && $ot->order['coupon_discount_amount'] + $ot->order['store_discount_amount']) }}
                                    </td>
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order && $ot->tax) }}</td>
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order && $ot->delivery_charge) }}
                                    </td>
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order && $ot->order_amount) }}
                                    </td>
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order && $ot->admin_expense) }}
                                    </td>
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order && $ot->discount_amount_by_store) }}
                                    </td>
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order && $ot->admin_commission + $ot->admin_expense - $ot->delivery_fee_comission - $ot->additional_charge) }}
                                    </td>
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order && $ot->additional_charge) }}
                                    </td>
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order && $ot->delivery_fee_comission) }}
                                    </td>
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order && $ot->admin_commission) }}
                                    </td>
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order && $ot->store_amount - $ot->tax) }}
                                    </td>
                                    ...
                                    @elseif ($ot->received_by == 'deliveryman')
                                        <td class="text-capitalize white-space-nowrap">
                                            ...
                                            <div class="text-right mw--85px">
                                                ...
                                                @elseif (isset($ot->delivery_man) &&
                                                        $ot->delivery_man &&
                                                        $ot->delivery_man->earning == 0 &&
                                                        $ot->delivery_man->type == 'zone_wise')
                                    ...
                                    @elseif ($ot->received_by == 'store')
                                        <td class="text-capitalize white-space-nowrap">{{ translate('messages.store') }}
                                        </td>
                                    @endif
