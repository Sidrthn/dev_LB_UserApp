                        ...
                        <div class="card-body">
                            <div class="py-2">
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        @php($cod_prevention = \App\Models\BusinessSetting::where('key', 'cod_prevention')->first())
                                        @php($cod_prevention = $cod_prevention ? $cod_prevention->value : 0)
                                        <div class="form-group mb-0">
                                            <label
                                                class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control">
                                                <span class="pr-1 d-flex align-items-center switch--label">
                                                    <span class="line--limit-1">
                                                        {{ translate('messages.COD_Prevention') }}
                                                    </span>
                                                    <span class="form-label-secondary text-danger d-flex"
                                                          data-toggle="tooltip" data-placement="right"
                                                          data-original-title="{{ translate('messages.With_this_feature,_it_enable_it_seems_customer_should_not_use_COD_when_they_cancel_the_orders.')}}"><img
                                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                            alt="{{ translate('messages.customer_varification_toggle') }}"> *
                                                    </span>
                                                </span>
                                                <input type="checkbox"  class="toggle-switch-input" value="1"
                                                       name="cod_prevention" id="schedule_order"
                                                    {{ $cod_prevention == 1 ? 'checked' : '' }}>
                                                <span class="toggle-switch-label text">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </label>
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        @php($cod_charges = \App\Models\BusinessSetting::where('key', 'cod_charges')->first())
                                        <div class="form-group mb-0">
                                            <label class="input-label text-capitalize d-flex alig-items-center"
                                                   for="schedule_order_slot_duration">
                                                ...
                                                <span class="pr-1 d-flex align-items-center switch--label">
                                                    <span class="line--limit-1">
                                                        {{ translate('messages.COD_Charges') }}
                                                    </span>
                                                    <span class="form-label-secondary text-danger"
                                                          data-toggle="tooltip" data-placement="right"
                                                          data-original-title="{{ translate('messages.When_enter_the_charges_it_should_add_in_the_total_of_the_payment.') }}"><img
                                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                            alt="{{ translate('Home Delivery') }}"></span>
                                                </span>
                                            </label>
                                            <div class="d-flex">
                                                <input type="text" name="cod_charges" class="form-control mr-3"
                                                       id="schedule_order_slot_duration"
                                                       value="{{ $cod_charges->value }}"
                                                >
                                            </div>
                                        </div>
                                    </div>
