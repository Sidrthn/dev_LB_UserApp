...
class CategoryLogic
{
    ...
    {
        // Subquery to calculate the total quantity sold for each item
        ...
        whereHas('module.zones', function($query) use ($zone_id) {
            ...
            ->leftJoinSub($orderDetailSubquery, 'order_details', function ($join) {
            ...
            ->active()
            ->type($type)
            ->orderBy('total_sold', 'desc') // Order by total sold count in descending order
            ->orderByRaw('items.stock = 0')
            ->latest() // Optionally, you can add other sorting criteria like 'latest'
